...
var addMOOC = function(){
    ...
    $('.MOOCList').append("<div class='input-field'><textarea class='materialize-textarea' id = 'MOOC" +count+ "'max-length = '100'></textarea><label class = 'thin-letters-3' for='textarea1'>MOOC</label></div>");
}
...
var addResearch = function(){
    ...
    $('.researchPaperList').append("<div class='input-field'><textarea class='materialize-textarea' id = 'researchPaper" +count+ "'max-length = '100'></textarea><label class = 'thin-letters-3' for='textarea1'>Research Paper</label></div>");
}
...
var addConference = function(){
    ...
    $('.conferenceList').append("<div class='input-field'><textarea class='materialize-textarea' id = 'conference" +count+ "'max-length = '100'></textarea><label class = 'thin-letters-3' for='textarea1'>Conference Attended</label></div>");
...
var check = function(){
    ...
    $.ajax({
        ...
        url: frm.attr('action'),
        data: {'skills':JSON.stringify(skillList),'aboutMe':$('.aboutMe').val(),'phoneNum':$('.phoneNum').val(),'share':$('.share').val(),
